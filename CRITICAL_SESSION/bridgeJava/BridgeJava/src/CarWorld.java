...
class CarWorld extends JPanel {
    ...
    public CarWorld() {
        ...
        redCar = toolkit.getImage("/home/cs399273/FACULDADE/PCD/CRITICAL_SESSION/bridgeJava/BridgeJava/src/image/redcar.gif");
        mt.addImage(redCar, 0);
        blueCar = toolkit.getImage("/home/cs399273/FACULDADE/PCD/CRITICAL_SESSION/bridgeJava/BridgeJava/src/image/bluecar.gif");
        mt.addImage(blueCar, 1);
        bridge = toolkit.getImage("/home/cs399273/FACULDADE/PCD/CRITICAL_SESSION/bridgeJava/BridgeJava/src/image/bridge1.gif");
